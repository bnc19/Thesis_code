...
################################################################################    
####################  scale ve against inf - CHANGE THIS FOR SA ################
chi = c(rep(log(12), 4), rep(log(12), 8))
...
# likely needs lower risk for tertiary/quaternary
    ...
    pars[[i]]$L_dis = matrix(c(1+pp$L.1.[i],1+pp$L.1.[i],1+pp$L.1.[i],1+pp$L.1.[i],
                               1,1,1,1,1,1,1,1),nrow = 4, ncol = 3)
    pars[[i]]$L_sdis = matrix(c(1+pp$L.1.[i]*pp$tau.1.[i],1+pp$L.1.[i]*pp$tau.2.[i],1+pp$L.1.[i]*pp$tau.3.[i],1+pp$L.1.[i]*pp$tau.4.[i],
                                1,1,1,1,1,1,1,1),nrow = 4, ncol = 3)
