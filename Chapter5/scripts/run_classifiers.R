...
# In the manuscript, each model was fit 100 times, using 100 bootstrap samples 
# of the test (10%) and train (90%) sets, in order to calculate mean and 95%  
# confidence intervals. Here, the code is set up to run each model just once  
# using a 50/50 test and train split, which takes ~5 minutes per model, on an 8 
# core laptop. 
